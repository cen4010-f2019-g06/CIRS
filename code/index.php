<!--
<?php include ("assests/pages/nav.php")?>
<?php $title = "Dashboard"; ?> 
-->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="center-element">
        ...
        <!-- #2 -->
                <article class="post-tile column-1-fourth">
                    <div class="post-tile__header">
                        <img class="post-tile__status" src="assets/images/icons/status/status-in-progress.svg">
                        <img src="assets/images/icons/default-user-icon.svg" class="user-avatar">
                    </div>
        ...
        <!-- #3 -->  
                <article class="post-tile column-1-fourth">
                    <div class="post-tile__header">
                        <img class="post-tile__status" src="assets/images/icons/status/status-reviewed.svg">
                        <img src="assets/images/icons/default-user-icon.svg" class="user-avatar">
                    </div>
        ...
        <!-- #12 -->   
            ...
            <div class="advice-col-container">
                ...
                <div class="advice-col-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua amore botem eda?</div>
                <footer>
                    <div class="advice-col__date"><time datetime="2019-08-30">Aug 30</time>
                        </div>
                        <div class="advice-col__comments">4 comments<img class="comment-icon" src="assets/images/icons/comment-icon.svg"></div>
                    </footer>
                </div>
                ...
                <div class="advice-col-box">
                    <img class="advice-icon" src="assets/images/icons/indicators/advice-indicator.svg"></div>
                <div class="advice-col-box"></div>
                <div class="advice-col-box"></div>
                <div class="advice-col-box"></div>
            </div>
